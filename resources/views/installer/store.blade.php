...
<div x-data="storeData()" class="bg-white rounded-lg shadow-sm border border-gray-200 p-8">
    <h2 class="text-2xl font-bold text-gray-900 mb-6">{{ __('Store & Currency Configuration') }}</h2>

    <form @submit.prevent="submitForm()" class="space-y-8">
        <!-- Store Information -->
        <div>
            <h3 class="text-lg font-semibold text-gray-900 mb-4">{{ __('Store Information') }}</h3>
            <div class="space-y-4">
                <div>
                    <label class="block text-sm font-medium text-gray-700 mb-2">{{ __('Store Name') }}</label>
                ...
                <div>
                    <label class="block text-sm font-medium text-gray-700 mb-2">{{ __('Store Address') }}</label>
                ...
                <div>
                    <label class="block text-sm font-medium text-gray-700 mb-2">{{ __('Contact Number') }}</label>
                ...
                <div>
                    <label class="block text-sm font-medium text-gray-700 mb-2">{{ __('Sale Prefix') }}</label>
                    ...
                    <p class="mt-1 text-sm text-gray-500">{{ __('Invoice numbers will be: OS-0001, OS-0002, etc.') }}</p>
                </div>
            </div>
        </div>
        ...
        <!-- Currency Settings -->
        <div>
            <h3 class="text-lg font-semibold text-gray-900 mb-4">{{ __('Currency Settings') }}</h3>
            <div class="space-y-4">
                <div class="grid grid-cols-2 gap-4">
                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-2">{{ __('Currency Symbol') }}</label>
                    ...
                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-2">{{ __('Currency Code') }}</label>
                ...
                <div class="grid grid-cols-2 gap-4">
                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-2">{{ __('Symbol Position') }}</label>
                        <select x-model="symbol_position" class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
                            <option value="before" x-text="'{{ __('Before (') }}' + currency_symbol + '100)'"></option>
                            <option value="after" x-text="'{{ __('After (100') }}' + currency_symbol + ')'"></option>
                        </select>
                    </div>
                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-2">{{ __('Decimal Places') }}</label>
                ...
                <div class="grid grid-cols-2 gap-4">
                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-2">{{ __('Decimal Separator') }}</label>
                    ...
                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-2">{{ __('Thousands Separator') }}</label>
                ...
                <div class="grid grid-cols-2 gap-4">
                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-2">{{ __('Negative Format') }}</label>
                        <select x-model="negative_format" class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
                            <option value="minus">{{ __('Minus (-100)') }}</option>
                            <option value="parentheses">{{ __('Parentheses ((100))') }}</option>
                        </select>
                    </div>
                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-2">{{ __('Show Currency Code') }}</label>
                        <select x-model="show_currency_code" class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
                            <option value="no" x-text="'{{ __('No (') }}' + currency_symbol + '100)'"></option>
                            <option value="yes" x-text="'{{ __('Yes (') }}' + currency_symbol + '100 ' + currency_code + ')'"></option>
                        </select>
                    </div>
                </div>
            </div>
...
function storeData() {
    ...
    return {
        ...
        init() {
            this.store_name = sessionStorage.getItem('store_name') || @json(__("Main Store"));
