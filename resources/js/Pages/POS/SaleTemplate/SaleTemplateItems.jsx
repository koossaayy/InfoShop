...
export default function SaleTemplateItem({ templates, setTemplates }) {
    ...
    const fillCart = (template) => {
        ...
        Swal.fire({
            title: t('Group item confirmation'),
            text: t('This will replace the items in your cart with the items in the selected group. Are you sure you want to do this?'),
            icon: 'question',
            showCancelButton: true,
            confirmButtonColor: '#3085d6',
            cancelButtonColor: '#d33',
            confirmButtonText: t('Yes, replace it!'),
            cancelButtonText: t('No, keep current items')
        }).then((result) => {
