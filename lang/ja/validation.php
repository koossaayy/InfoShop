...
return [
    ...
    */
    ...
    'attributes' => [
        ...
        'address' => '住所',
        'adjusts_balance' => '残高を調整',
        'admin' => '管理者',
        'admin_email' => '管理者メールアドレス',
        'admin_name' => '管理者名',
        'admin_password' => '管理者パスワード',
        'admin_username' => '管理者ユーザー名',
        'alert_quantity' => 'アラート数量',
        'allowances' => '手当',
        'amount' => '金額',
        'app_name' => 'アプリ名',
        'app_timezone' => 'アプリのタイムゾーン',
        'app_url' => 'アプリURL',
        ...
        'is_active' => '有効',
        'is_default' => 'デフォルト',
        'is_stock_managed' => '在庫管理あり',
        'issued_date' => '発行日',
        'joined_at' => '登録日',
        'message' => 'メッセージ',
        'name' => '名前',
        'negative_format' => '負数の形式',
        'net_salary' => '手取り給与',
        'net_total' => '合計金額',
        'note' => 'メモ',
        'original_image' => '元画像',
        ...
        'salary' => '給与',
        'salary_date' => '給与日',
        'salary_frequency' => '給与頻度',
        'salary_from' => '給与開始日',
        'sale_prefix' => '売上プレフィックス',
        'sample_data' => 'サンプルデータ',
        'shop_logo' => 'ショップロゴ',
        'shop_name' => 'ショップ名',
        'show_currency_code' => '通貨コードを表示',
        'sku' => 'SKU',
        'slug' => 'スラッグ',
        'status' => 'ステータス',
        'stock_id' => '在庫ID',
        'store_address' => '店舗住所',
        'store_contact' => '店舗の連絡先',
        'store_id' => '店舗ID',
        'store_name' => '店舗名',
        'success' => '成功',
        'summary' => '概要',
        'symbol_position' => '記号の位置',
        'template' => 'テンプレート',
        'template_name' => 'テンプレート名',
        'terms_conditions' => '利用規約',
        'thousands_separator' => '桁区切り文字',
        'token' => 'トークン',
