...
return [
    ...
    */
    ...
    'attributes' => [
        ...
        'collection_ids' => 'ID инкассаций',
        'collection_type' => 'Тип инкассации',
        'contact_id' => 'ID контакта',
        'contact_number' => 'Номер контакта',
        'cost' => 'Себестоимость',
        'currency_code' => 'Код валюты',
        'currency_symbol' => 'Символ валюты',
        'current_password' => 'Текущий пароль',
        'current_sale_number' => 'Текущий номер продажи',
        'customer_notes' => 'Заметки о клиенте',
        ...
        'error' => 'Ошибка',
        'errors' => 'Ошибки',
        'excludeInvoiceNumbers' => 'ExcludeInvoiceNumbers',
        'expiry_date' => 'Срок годности',
        'featured_image' => 'Главное изображение',
        'gender' => 'Пол',
        'gross_salary' => 'Зарплата до вычетов',
        'host' => 'Хост',
        'id' => 'ID',
        'image' => 'Изображение',
        'is_active' => 'Активен',
        'is_default' => 'По умолчанию',
        'is_stock_managed' => 'Управление остатками',
        'issued_date' => 'Дата выдачи',
        'joined_at' => 'Дата присоединения',
        'message' => 'Сообщение',
        'name' => 'Название',
        'negative_format' => 'Формат отрицательных значений',
        'net_salary' => 'Зарплата после вычетов',
        'net_total' => 'Итого без скидки',
        'note' => 'Примечание',
        ...
        'quantity' => 'Количество',
        'quotation_date' => 'Дата коммерческого предложения',
        ...
        'salary_frequency' => 'Периодичность зарплаты',
        'salary_from' => 'Зарплата от',
        'sale_prefix' => 'Префикс продажи',
        'sample_data' => 'Пример данных',
        'shop_logo' => 'Логотип магазина',
        'shop_name' => 'Название магазина',
        'show_currency_code' => 'Показывать код валюты',
        'sku' => 'Артикул',
        'slug' => 'Слаг',
        'status' => 'Статус',
        'stock_id' => 'ID остатка',
        'store_address' => 'Адрес магазина',
        'store_contact' => 'Контакт магазина',
