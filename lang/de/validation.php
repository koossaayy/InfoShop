...
return [
    ...
    */
    ...
    'attributes' => [
        ...
        'address' => 'Adresse',
        'adjusts_balance' => 'Passt den Saldo an',
        'admin' => 'Admin',
        ...
        'charge_type' => 'Aufschlagsart',
        'cheque_date' => 'Scheckdatum',
        'cheque_number' => 'Schecknummer',
        'collection_ids' => 'Inkasso-IDs',
        'collection_type' => 'Art des Einzugs',
        ...
        'current_sale_number' => 'Aktuelle Verkaufsnummer',
        ...
        'is_stock_managed' => 'Bestand wird verwaltet',
        'issued_date' => 'Ausstellungsdatum',
        'joined_at' => 'Beigetreten am',
        'message' => 'Nachricht',
        'name' => 'Name',
        'negative_format' => 'Negativformat',
        ...
        'salary_frequency' => 'Gehaltsintervall',
        'salary_from' => 'Gehalt von',
        'sale_prefix' => 'Verkaufspräfix',
        'sample_data' => 'Beispieldaten',
        'shop_logo' => 'Shop-Logo',
        'shop_name' => 'Shopname',
        'show_currency_code' => 'Währungscode anzeigen',
        'sku' => 'SKU',
        'slug' => 'Slug',
        'status' => 'Status',
        'stock_id' => 'Bestands-ID',
        'store_address' => 'Adresse der Filiale',
        'store_contact' => 'Store-Kontakt',
        'store_id' => 'Store-ID',
        'store_name' => 'Name der Filiale',
        'success' => 'Erfolg',
        'summary' => 'Zusammenfassung',
        'symbol_position' => 'Position des Symbols',
        'template' => 'Vorlage',
