...
return [
    ...
    */
    ...
    'attributes' => [
        ...
        'address' => 'Adresse',
        'adjusts_balance' => 'Ajuste le solde',
        'admin' => 'Admin',
        ...
        'collection_ids' => 'ID des encaissements',
        'collection_type' => 'Type d’encaissement',
        ...
        'current_sale_number' => 'Numéro de vente actuel',
        ...
        'error' => 'Erreur',
        'errors' => 'Erreurs',
        'excludeInvoiceNumbers' => 'Exclure les numéros de facture',
        ...
        'is_stock_managed' => 'Gestion du stock activée',
        'issued_date' => 'Date d’émission',
        'joined_at' => 'Date d’adhésion',
        'message' => 'Message',
        'name' => 'Nom',
        'negative_format' => 'Format négatif',
        ...
        'phone' => 'Téléphone',
        'price' => 'Prix',
        'profit_amount' => 'Montant du bénéfice',
        'purchase_date' => 'Date d’achat',
        'quantity' => 'Quantité',
        'quotation_date' => 'Date du devis',
        'rate_type' => 'Type de taux',
        'rate_value' => 'Valeur du taux',
        'reason' => 'Motif',
        ...
        'role' => 'Rôle',
        'salary' => 'Salaire',
        'salary_date' => 'Date du salaire',
        'salary_frequency' => 'Fréquence du salaire',
        'salary_from' => 'Salaire de',
        'sale_prefix' => 'Préfixe de vente',
        'sample_data' => 'Données d’exemple',
        'shop_logo' => 'Logo de la boutique',
        'shop_name' => 'Nom de la boutique',
        'show_currency_code' => 'Afficher le code de devise',
        'sku' => 'UGS',
        'slug' => 'Slug',
        'status' => 'Statut',
        'stock_id' => 'ID du stock',
        'store_address' => 'Adresse du magasin',
        'store_contact' => 'Contact du magasin',
